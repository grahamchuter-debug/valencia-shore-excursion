...
export const metadata = buildMetadata({
  title: "Valencia Cruise Ship Schedules",
  description:
    "Valencia cruise ship schedules by year and month. See which ships call before booking Old Town, City of Arts or city excursions.",
  path,
  keywords: ["Valencia cruise ship schedule", "Valencia cruise calendar", "Valencia ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Valencia Cruise Ship Schedules", description: "Valencia cruise ship schedules by year and month.", path })]} />
      <PageHero title="Valencia Cruise Ship Schedules" subtitle="See which ships are in port before you book Valencia excursions. Times and berths are indicative — always confirm with your cruise line." compact />
