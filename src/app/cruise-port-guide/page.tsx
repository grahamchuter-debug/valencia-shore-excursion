...
const description =
  "The complete Valencia cruise port guide — terminal layout, walking routes, taxis, old town access and return-to-ship timing.";
...
export const metadata = buildMetadata({
  ...
  image: image.src,
  imageAlt: image.alt,
  keywords: ["Valencia cruise port", "Valencia cruise terminal", "Valencia port to old town", "Valencia cruise port guide"],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Valencia Cruise Port Guide", path },
];
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-12">
            <FAQSection faqs={portGuideFaqs} title="Valencia port FAQs" />
          </div>
