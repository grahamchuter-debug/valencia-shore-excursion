  ...
  if (!product) {
    return {
      ...buildMetadata({
        ...
        description:
          "Valencia shore excursion online booking opens once EUR selling prices and fulfilment routes are verified. Enquire for guidance in the meantime.",
        path: `/book/${slug}`,
        noindex: true,
      }),
      title: { absolute: "Online Booking Not Yet Open | Valencia Shore Excursions" },
    };
  }
  return buildMetadata({
    title: `Book ${product.name}`,
    description: `Book ${product.experienceName} from Valencia. ${formatBookingMoney(product.priceAmount)} per guest. Secure online booking with return-to-ship planning.`,
      ...
      <main className="flex-1">
        <section className="container-wide section-padding max-w-2xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-gray-700">
            Valencia shore excursions will become bookable online once EUR selling prices and
