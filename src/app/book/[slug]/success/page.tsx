  ...
  if (!product) {
    return {
      ...buildMetadata({
        ...
        description:
          "Valencia shore excursion booking confirmation pages activate when online checkout is live. Contact us if you need help with an existing enquiry.",
        path: `/book/${slug}/success`,
        noindex: true,
      }),
      title: { absolute: "Booking Confirmation Not Available | Valencia Shore Excursions" },
    };
  }
  return buildMetadata({
    title: `Booking Confirmed — ${product.name}`,
    description: `Your ${product.experienceName} booking confirmation from Valencia Shore Excursions.`,
      ...
      <main className="flex-1">
        <section className="container-wide section-padding max-w-2xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-gray-700">
            Online checkout for Valencia shore excursions is not live. When booking opens, confirmation
