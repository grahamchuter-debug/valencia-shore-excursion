...
import { signatureValenciaExperience, SIGNATURE_EXPERIENCE_PATH } from "@/data/signature-experience";
import { subjectImages } from "@/lib/images";
import { ResponsiveImage } from "@/components/ResponsiveImage";
import { PreloadImage } from "@/components/PreloadImage";

const path = SIGNATURE_EXPERIENCE_PATH;
const image = subjectImages["city-of-arts"];

export const metadata = buildMetadata({
  title: signatureValenciaExperience.seoTitle,
  description: signatureValenciaExperience.metaDescription,
  path,
  image: image.src,
  imageAlt: "City of Arts and Sciences — future Signature Experience from Valencia cruise port",
  keywords: [
    "Signature Mediterranean Valencia Discovery",
    "Valencia shore excursions",
    "small group Valencia tour",
...
const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Signature Mediterranean Valencia Discovery", path },
];

export default function SignatureValenciaExperiencePage() {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbSchema(breadcrumbs),
          faqSchema(signatureValenciaExperience.faqs),
          articleSchema({
            title: signatureValenciaExperience.seoTitle,
            description: signatureValenciaExperience.metaDescription,
            path,
      ...
      <section className="section-signature-hero">
        ...
        <div className="container-wide relative z-10 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <h1 className="home-hero-heading mt-6 max-w-3xl">{signatureValenciaExperience.title}</h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/90">
            {signatureValenciaExperience.tagline}
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/75">
            {signatureValenciaExperience.overview}
          </p>
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="placeholder-widget mt-8">
            ...
            <p className="mt-3 text-gray-700 leading-relaxed">
              ...
              guests, cruise-timed routing and a carefully paced Valencia day. It is a
              concept in preparation, not a currently bookable excursion.
            </p>
          </div>

          <div className="mt-10 grid gap-3 sm:grid-cols-2">
            {signatureValenciaExperience.benefits.map((b) => (
          ...
          <div className="mt-12">
            <FAQSection faqs={signatureValenciaExperience.faqs} title="Signature Mediterranean Valencia Discovery — FAQs" />
          </div>
