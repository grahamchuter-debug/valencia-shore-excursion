...
export const metadata = buildMetadata({
  title: "Terms of Use",
  description: `Terms of use for ${SITE.name} — the basis on which we provide our Valencia cruise planning guides and information.`,
  path,
  noindex: true,
});
      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-gray-700 leading-relaxed">
            <p>{SITE.name} provides planning information and guidance for cruise passengers calling at Valencia. It is offered in good faith for general guidance and does not constitute professional travel advice.</p>
            ...
            <p>We are not affiliated with any cruise line, the Port of Valencia or excursion operators listed on this site unless explicitly stated.</p>
            <p>
              Contact:{" "}
