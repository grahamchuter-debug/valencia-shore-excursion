...
const path = "/guides";
const description =
  "Valencia cruise planning guides — Old Town, Central Market, La Lonja, City of Arts and Sciences and practical port-day advice.";

export const metadata = buildMetadata({
  title: "Valencia Cruise Planning Guides",
  description,
  path,
  keywords: [
    "Valencia cruise port guide",
    "City of Arts from Valencia",
    "Valencia shore excursions guide",
    "Valencia Old Town from cruise port",
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Valencia Cruise Planning Guides", description, path }),
        ]}
      />
      <PageHero
        title="Valencia Cruise Planning Guides"
        subtitle="Your gateway to Valencia — Old Town, Central Market, La Lonja, Turia Gardens, City of Arts and practical advice for every type of cruise passenger."
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="section-subtitle">Practical guides to Valencia highlights with transfer times and return-to-ship advice.</p>
