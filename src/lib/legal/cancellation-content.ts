...
export const cancellationContent: CancellationPolicyContent = {
  ...
  metaDescription:
    "Cancellation terms for Valencia Shore Excursions bookings. Cruise plans can change — this page explains how cancellations are handled once terms are confirmed.",
