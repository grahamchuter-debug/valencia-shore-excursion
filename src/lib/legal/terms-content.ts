...
export const termsContent: LegalPageContent = {
  ...
  metaDescription:
    "Booking terms and conditions for Valencia Shore Excursions shore excursions for cruise passengers.",
  lastUpdated: BUSINESS_DECISION_REQUIRED,
  lead: `These terms explain how bookings work with ${businessIdentity.tradingName}. They apply to shore excursions arranged for cruise passengers visiting Valencia.`,
  sections: [
    {
      id: "about-us",
      title: "1. About Us",
      paragraphs: [
        `${businessIdentity.tradingName} arranges small-group shore excursions for cruise passengers calling at Valencia on Spain's Mediterranean coast.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Please tell us as soon as possible if your cruise line changes your call at Valencia so we can review your booking.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Cruise itineraries and arrival arrangements can occasionally change. Contact us as soon as possible if your cruise line alters your Valencia visit so we can review the arrangements for your booking.",
    ...
    },
    {
      ...
      paragraphs: [
        "Your excursion is planned around the operating times of your cruise ship, with appropriate time allowed for your return to Valencia.",
