/**
 * Booking engine configuration — Valencia multi-product checkout experience.
 */
...
export const bookingPrototypeTour: BookingTourView = (() => {
  const first = getBookableProduct("valencia-highlights-city-of-arts");
...
export const bookingPricingConfig = {
  ...
  priceConfigured: Boolean(getBookableProduct("valencia-highlights-city-of-arts")),
  ...
  returnGuaranteeDetail:
    "Your itinerary is planned to return you to Valencia with time before your ship departs.",
...
export const bookingCheckoutCopy = {
  ...
  reconnectLine: "Your Valencia day is almost booked.",
