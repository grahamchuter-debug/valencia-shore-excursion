...
function MarkSvg({
  ...
  // Concept A (active): Anchor Arch — Mediterranean harbour mark meeting a restrained anchor.
  return (
    <svg
      width={size}
      height={size}
 ...
 *
 * Logo refinement: icon slightly subordinate to destination wordmark,
...
export function DestinationLogo({
  ...
  const onDark = tone === "on-dark";
  // ~12% smaller than the first prototype so the destination wordmark stays dominant
