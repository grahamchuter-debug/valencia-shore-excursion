...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Valencia Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "city-of-arts-and-sciences" || page.slug === "valencia-old-town") && (
            <SignatureExperienceCallout
              context={page.slug === "city-of-arts-and-sciences" ? "portofino" : "savona"}
            />
          )}

          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Valencia guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Valencia — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
