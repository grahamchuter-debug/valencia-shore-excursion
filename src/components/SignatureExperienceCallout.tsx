...
const CONTEXT_COPY = {
  portofino:
    "Considering the City of Arts? Our future Signature Mediterranean Valencia Discovery is being designed as a carefully paced small-group day linking historic and modern Valencia.",
  savona:
    "Exploring Valencia? Our future Wow Collection will add distinctive small-group Mediterranean routes developed around cruise timings.",
  general:
    "Our future flagship Signature Mediterranean Valencia Discovery is a proposed small-group experience. It is still in preparation.",
};
  ...
  if (compact) {
    return (
      <div className="card-signature mt-10">
        ...
        <h2 className="mt-4 font-display text-xl font-bold text-gray-900">{signatureValenciaExperience.title}</h2>
