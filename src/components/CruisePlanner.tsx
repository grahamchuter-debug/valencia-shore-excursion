...
export function CruisePlanner() {
  ...
  const [interests, setInterests] = useState<string[]>(["old-town", "city-of-arts"]);
  ...
  function downloadPdf() {
    ...
    doc.save("valencia-cruise-plan.pdf");
  }
  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Valencia plan</button>
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">Guidance is indicative — always confirm your ship&apos;s all-aboard time and build a 60–90 minute return buffer. Traffic on the V-30 ring road and A-7 toward Sagunto can lengthen journey times on longer road days.</p>
        </div>
      )}
    </div>
  );
