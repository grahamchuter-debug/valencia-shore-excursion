      ...
      <div className="container-wide">
        <div className="card-signature grid gap-0 overflow-hidden border-white/10 bg-white/5 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center bg-[#faf8f5] p-8 text-gray-900 sm:p-10 lg:p-12">
            <p className="section-eyebrow text-coastal-700">Future Valencia exclusives</p>
            ...
            <p className="mt-4 text-base italic leading-relaxed text-gray-700">
              &ldquo;A future collection of distinctive small-group Valencian days, developed around
              local expertise, thoughtful pacing and the realities of a Valencia cruise call.&rdquo;
            </p>
            <p className="mt-4 text-sm leading-relaxed text-gray-600">
              The collection is still in preparation. Proposed experiences include historic centre and
              City of Arts combinations, local neighbourhood discovery and culinary routes. None should
              be treated as currently bookable until partners, access and sailing-specific logistics are confirmed.
            </p>

            <div className="mt-6 grid gap-2 sm:grid-cols-2">
              {[
                { emoji: "🏛", text: "Future historic + City of Arts day" },
                { emoji: "🍽️", text: "Future culinary discovery concept" },
                { emoji: "🚶", text: "Future local Valencia routes" },
