# Valencia Shore Excursions — remaining destination work

Config generated for `valencia` with domain `valenciashoreexcursion.com` and `contactMode: "central"` (info@wowatour.com).
...
- [ ] `wrangler d1 create valencia-bookings` → set database_id
- [ ] Stripe + Resend secrets
- [ ] Confirm DNS for valenciashoreexcursion.com
